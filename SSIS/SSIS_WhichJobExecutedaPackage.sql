--File: SSIS\WhichJobExecutedaPackage.sql
--Extracted from https://www.mssqltips.com/sqlservertip/2561/querying-sql-server-agent-job-information/
...
WHERE [sJSTP].[subsystem] = 'SSIS' -- Change or comment this line to check job steps in general.
