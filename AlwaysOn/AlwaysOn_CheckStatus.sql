--File: AlwaysOn\AlwaysOn_CheckStatus.sql
--Extracted from https://sqlperformance.com/2015/08/monitoring/availability-group-replica-sync
--Compilled in https://github.com/beumof/SQL-Server-Admin-scripts
--Added in 2020-02-27

-- This script will check AlwaysOn status
