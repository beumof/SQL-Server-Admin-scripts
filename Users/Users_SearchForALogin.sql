...
--Extracted from: https://dba.stackexchange.com/questions/81595/a-query-that-lists-all-mapped-users-for-a-given-login
...
AND user1.UserName = @loginName -- Commnet line for all logins in SQL instance
